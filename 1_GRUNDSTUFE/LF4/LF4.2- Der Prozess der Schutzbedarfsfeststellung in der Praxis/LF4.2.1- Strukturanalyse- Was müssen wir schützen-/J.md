...
2. **Abhängigkeiten visualisieren:** Erstellt eine einfache Mindmap oder ein Diagramm (z.B. mit Miro oder [draw.io](http://draw.io)), das die Abhängigkeiten zwischen den von euch identifizierten Zielobjekten darstellt. Welche Anwendung läuft auf welcher Hardware? Welche Informationen werden von welcher Anwendung verarbeitet?![diagram.drawio.svg](files/019cee46-8a70-722a-8218-26ab8cf75a41/diagram.drawio.svg)
