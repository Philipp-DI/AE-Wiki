...
1. **Zielobjekte identifizieren:** Nehmt das Szenario des Grafikdesigner-Arbeitsplatzes aus dem Lern-Epic. Erstellt in einem geteilten Dokument (z.B. einer Tabelle) eine Liste aller Zielobjekte, unterteilt nach den Kategorien (**Anwendungen & Prozesse, IT-Systeme, Räume, Kommunikationsverbindungen**). → https://www.bsi.bund.de/DE/Themen/Unternehmen-und-Organisationen/Standards-und-Zertifizierung/IT-Grundschutz/Zertifizierte-Informationssicherheit/IT-Grundschutzschulung/Online-Kurs-IT-Grundschutz/Lektion_4_Schutzbedarfsfeststellung/Lektion_4_04/Lektion_4_04_node.html
  ...
  **2\. Abhängigkeiten visualisieren:** Erstellt eine einfache Mindmap oder ein Diagramm (z.B. mit Miro oder [draw.io](http://draw.io)), das die Abhängigkeiten zwischen den von euch identifizierten Zielobjekten darstellt. Welche Anwendung läuft auf welcher Hardware? Welche Informationen werden von welcher Anwendung verarbeitet?

![](files/019cee46-8c6a-705b-bded-73a6d7bde697/VISUALISIERUNG_der_Abhängigkeiten.png)

| System / Anwendung | Verarbeitete Datenarten | Beispiele | Zweck / Besonderheit |
| --- | --- | --- | --- |
| **Desktop (Büro-PC)** | Kundendaten, Grafik- & Projektdaten, Dokumente | Kundenlogo.psd, Rechnung.pdf | Zentrale Arbeitsumgebung |
| **NAS (Lokaler Server)** | Sensible interne Daten, Backups | Archivierte Kundenprojekte, Sicherung der Rechnungen | Interner, geschützter Speicher |
| **Cloud (Adobe CC etc.)** | Arbeitskopien, Projektdateien, ggf. Kundendaten | Creative Cloud Projekte, Online-Freigaben | Online-Zusammenarbeit, mobile Arbeit |
| **Netzwerk (LAN/WAN)** | Datenpakete, Protokolle, Übertragungen | Upload/Download von Projekten | Verbindet interne und externe Systeme |
...
4. **Eigener Arbeitsplatz:** Führt eine vereinfachte Strukturanalyse eures eigenen (Lern-)Arbeitsplatzes Zuhause durch. Listet die wichtigsten Anwendungen, IT-Systeme und Informationen auf, mit denen ihr täglich arbeitet.
  
  | Wer | Anwendungen | IT-Systeme | Informationen |
  | --- | --- | --- | --- |
  | Jay | Teams/Chrome/ChatGpt | Laptop/Smartphone/WLAN | DocMost/YouTube Videos |
  | Philipp | OS/Teams/Browser | Laptop/Smartphone/Router | Lern-, Arbeits- & Projektinhalte |
  | Mohammed | Google Chrome, Teams, Outlook Web, Gmail, Google Drive, Canva | Laptop/Smartphone/Router | Umschulung Inhalte, Youtube Videos |
  | Olena | Teams, Browser, Outlook, Cloud | WLAN-Router (Fritz!Box), Externe Festplatte, Smartphone | Zugangsdaten (Passwörter) |
  | Janine | Teams/Edge/ChatGpt | Laptop/Smartphone/Router | Schulungsunterlagen, Notizen, persönliche Lernprojekte |
