...
# LF4.3.5- Angriffe der nächsten Generation- KI-gestützte Bedrohungen
...
1. **Deepfake-Recherche:** Recherchiert einen realen Fall von CEO-Betrug, bei dem eine geklonte Stimme zum Einsatz kam. Fasst den Fall kurz zusammen und beschreibt den entstandenen Schaden.  
  <br/>Deepfake-Recherche (CEO-Betrug)
  - Angreifer klonten die **Stimme eines CEOs**
  - Anruf bei Buchhaltung mit **dringender Zahlungsanweisung**
  - Stimme klang echt, Zeitdruck wurde aufgebaut
  - **Schaden: mehrere 100.000 Euro**
  - Überweisung erfolgte ohne Rückruf oder Prüfung
2. **Analyse:** Vergleicht eine "klassische" Phishing-Mail mit einer hypothetischen, KI-generierten Spear-Phishing-Mail. Erstellt eine Tabelle mit den Unterschieden in Bezug auf Anrede, Sprache, Inhalt und Glaubwürdigkeit.
  ...
  | Merkmal | Klassisches Phishing | KI-generiertes Spear-Phishing |
  | --- | --- | --- |
  | Anrede | Unpersönlich | Persönlich, korrekt |
  | Sprache | Fehlerhaft | Fehlerfrei, natürlich |
  | Inhalt | Allgemein | Kontextbezogen, passend |
  | Glaubwürdigkeit | Niedrig | Sehr hoch |
...
3. **Verhaltensregeln entwerfen:** Erstellt in der Gruppe einen kurzen Leitfaden (5 Verhaltensregeln) für Mitarbeiter der "KreativKopf GmbH" zum Thema "Umgang mit unerwarteten Anrufen oder E-Mails von der Geschäftsführung mit Zahlungsaufforderungen". Was sollte man tun, um einen Deepfake-Betrug zu verhindern?  
  <br/>Verhaltensregeln (5 Regeln)
  1. **Keine Zahlungen auf Zuruf**
  2. **Immer Rückruf über bekannte Nummer**
  3. **Vier-Augen-Prinzip bei Geld**
  4. **Zeitdruck ignorieren**
  5. **Verdacht sofort an IT/Security melden**
